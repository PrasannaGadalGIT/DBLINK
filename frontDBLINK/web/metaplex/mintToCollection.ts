...
(async () => {
  ...
  // generate a new Keypair for testing, named `reciever`
  ...
  console.log("Test address:", reciever.publicKey.toBase58());
  ...
  // const metaplex = Metaplex.make(connection).use(keypairIdentity(reciever));
