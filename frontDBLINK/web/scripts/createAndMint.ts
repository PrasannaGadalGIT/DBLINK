...
(async () => {
  ...
  const reciever = loadOrGenerateKeypair("reciever");
  ...
  console.log("Test wallet address:", reciever.publicKey.toBase58());
  ...
  */
  ...
  console.log(`Minting a single compressed NFT to ${reciever.publicKey.toBase58()}...`);
